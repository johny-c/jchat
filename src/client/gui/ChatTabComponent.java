 ...
 * @author johny
 */
public class ChatTabComponent extends javax.swing.JPanel {

    ChatTabbedPane tabs;
    Integer convId;

    /**
     * Creates new form JTabComp
     *
     * @param pane
     */
    public ChatTabComponent(ChatTabbedPane tabs, Integer convId) {
        this.tabs = tabs;
        this.convId = convId;
        initComponents();
    }
